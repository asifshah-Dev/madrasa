...
<head>
    <title>Thermal Print View</title>
    <meta charset="utf-8">
    ...
    <style>
        /* THERMAL PRINTER SPECIFIC STYLES - RTL URDU VERSION */
        * {
...
<body>
    <div class="no-print">
        ...
        <small>80mm | Original Amounts | Auto-print enabled</small><br>
        <button onclick="window.print()">PRINT</button>
        <button class="cancel" onclick="window.location.href='student_feecards.php'">CANCEL</button>
    </div>
    ...
    <div class="thermal-container">
        ...
        <div class="thermal-slip">
                ...
                <table class="thermal-fee-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="month-col"><?php echo $fee['month']; ?></td>
                ...
                <table class="thermal-fee-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="amount-col"><?php echo number_format($card['total_amount']); ?>/-</td>
                            <td class="amount-col"><?php echo number_format($card['paid_amount']); ?>/-</td>
                            <td class="amount-col"><?php echo number_format($card['amount']); ?>/-</td>
                        </tr>
                        <?php 
                                    endif;
                                endif;
                        ...
                        <tr class="thermal-total-row">
                            ...
                            <td class="amount-col"><?php echo number_format($month_total); ?>/-</td>
                            <td class="amount-col"><?php echo number_format($month_paid); ?>/-</td>
                            <td class="amount-col"><?php echo number_format($month_balance); ?>/-</td>
                        </tr>
                    </tbody>
                </table>
            ...
            if (!$has_any_fees): 
            ?>
            <div style="text-align: center; padding: 5px; font-weight: bold; color: #000; font-family: 'Noto Nastaliq Urdu', Arial, sans-serif;">
